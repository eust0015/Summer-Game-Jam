...
public class SinkCup : MonoBehaviour, IInteractable
{
	public float InteractionTime { get; set; } = 0f;
	[SerializeField] private Tap tapReference;
	Animator anim;
	...
	public void OnFocus()
	{
		...
		Debug.Log("SinkCup focused");
	}

	public void OnUnfocus()
	{
		anim?.SetBool("isFocused", false);
		Debug.Log("SinkCup Unfocused");
		// Code to execute when the door loses focus
	}

	public void OnInteract(GameObject obj)
	{
		Debug.Log("Interacted with SinkCup");
